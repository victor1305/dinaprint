    ...
    <main>
      ...
      <section className="px-5 py-10 mx-auto max-w-[1200px]">
        ...
        <p className="pt-4 text-base lg:text-lg">
          En Dinaprint llevamos más de 25 años ayudando a empresas y
          particulares a materializar sus proyectos de comunicación gráfica.
          Nuestra imprenta en Madrid ofrece soluciones completas: desde el
          asesoramiento inicial y la preimpresión hasta la producción,
          acabados y distribución. Trabajamos con las últimas tecnologías de
          impresión digital y offset para garantizar la máxima calidad en cada
          trabajo.
        </p>
        <p className="pt-4 text-base lg:text-lg">
          Estamos ubicados en Pinto, en el sur de Madrid, con excelente acceso
          desde la capital y toda la zona sur. Nuestro equipo te asesorará
          sobre materiales, papeles, gramajes y acabados para que elijas la
          opción más adecuada según tu proyecto y presupuesto.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
          <div className="p-5 rounded-xl shadow-findBox bg-white">
            ...
            <p className="pt-2">
              Ideal para tiradas cortas y medias, personalización variable y
              entregas rápidas. Utilizamos equipos de última generación como la
              Fuji Jet Press 7S, que alcanza más del 90 % de la gama Pantone.
              Perfecta para pruebas, prototipos, muestras y producciones que
          ...
          <div className="p-5 rounded-xl shadow-findBox bg-white">
            ...
            <p className="pt-2">
              Recomendable para tiradas grandes donde la consistencia de color
              y el coste unitario son clave. Garantizamos resultados
              profesionales en revistas, catálogos, folletos y cualquier
              producto que requiera alta calidad y volumen.
            </p>
          </div>
        </div>
        ...
        <p className="pt-4 text-base lg:text-lg">
          Nuestra imprenta en Madrid cubre todas las necesidades de
          comunicación gráfica de tu negocio:
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-6">
          ...
          >
            ...
            <p className="text-sm pt-1">
              Encuadernación wire-o, hilo, cola PUR y grapado.
            </p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-sm pt-1">
              Buzoneo, promociones y puntos de venta.
            </p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-sm pt-1">
              Papel, rígidos, lonas y materiales especiales.
            </p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-sm pt-1">
              Packaging personalizado con acabados premium.
            </p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-sm pt-1">
              Soluciones para ferias, eventos y punto de venta.
            </p>
          </Link>
        </div>
        ...
        <p className="pt-4 text-base lg:text-lg">
          Complementamos la impresión con una amplia gama de acabados para dar
          un toque distintivo a tu material:
        </p>
        <ul className="list-disc pl-5 pt-4 space-y-2">
          <li>
            <strong>Plastificados:</strong> mate, brillo y soft-touch para
            proteger y realzar.
          </li>
          <li>
            <strong>Barnices:</strong> UVI selectivo, reserva de brillo y
            barniz aroma.
          </li>
          <li>
            <strong>Troquelados:</strong> formas especiales, ventanas y
            perforaciones.
          </li>
          <li>
            <strong>Encuadernaciones:</strong> wire-o, espiral, cosido, fresado
            y cola PUR.
          </li>
          <li>
            <strong>Stamping y relieve:</strong> golpe en seco, hot stamping
            oro/plata.
          </li>
        </ul>
        ...
        <p className="pt-4 text-base lg:text-lg">
          Damos servicio a toda la Comunidad de Madrid y especialmente a la
          zona sur: Pinto, Valdemoro, Getafe, Parla, Fuenlabrada, Leganés,
          Alcorcón y alrededores. También enviamos a toda España sin coste
          adicional en la mayoría de pedidos.
        </p>
