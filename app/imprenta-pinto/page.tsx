    ...
    <main>
      ...
      <section className="px-5 py-10 mx-auto max-w-[1200px]">
        ...
        <p className="pt-4 text-base lg:text-lg">
          Dinaprint es una imprenta ubicada en Pinto (Madrid) con más de 25
          años de experiencia en el sector gráfico. Si buscas una imprenta
          cercana con atención personalizada, somos tu mejor opción. Te
          ayudamos a preparar tus archivos, elegir el papel y los acabados
          adecuados, y te asesoramos sobre la mejor tecnología de impresión
          según tu tirada y presupuesto.
        </p>
        <p className="pt-4 text-base lg:text-lg">
          Trabajamos tanto con empresas como con particulares, desde pequeños
          encargos hasta grandes tiradas. Nuestra ubicación en el sur de Madrid
          nos permite dar servicio rápido a toda la zona: Valdemoro, Getafe,
          Parla, Fuenlabrada y, por supuesto, Madrid capital.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
          <div className="p-5 rounded-xl shadow-findBox bg-white">
            ...
            <p className="pt-2">
              Revisión y optimización de archivos. Comprobamos resolución,
              sangrados, tipografías y colores antes de imprimir.
            </p>
          </div>
          <div className="p-5 rounded-xl shadow-findBox bg-white">
            <h4 className="text-xl font-semibold">Impresión</h4>
            <p className="pt-2">
              Digital para tiradas cortas y offset para grandes volúmenes.
              Máxima calidad y consistencia de color.
            </p>
          </div>
          <div className="p-5 rounded-xl shadow-findBox bg-white">
            <h4 className="text-xl font-semibold">Acabados</h4>
            <p className="pt-2">
              Plastificados, barnices, troquelados, encuadernaciones, stamping
              y manipulados especiales.
            </p>
          </div>
        </div>
        ...
        <ul className="list-disc pl-5 pt-4 space-y-2">
          <li>
            <strong>Cercanía:</strong> puedes visitarnos, ver muestras y recoger
            tu pedido.
          </li>
          <li>
            <strong>Asesoramiento:</strong> te ayudamos a elegir materiales y
            acabados.
          </li>
          <li>
          ...
          <li>
            <strong>Envíos gratuitos:</strong> entrega en península sin coste
            adicional.
          </li>
          <li>
