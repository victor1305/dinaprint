    ...
    <main>
      ...
      <section className="px-5 py-10 mx-auto max-w-[1200px]">
        ...
        <p className="pt-4 text-base lg:text-lg">
          Si tu empresa está en el sur de Madrid y buscas una imprenta cercana
          con trato directo, en Dinaprint te ofrecemos la combinación perfecta
          de cercanía, calidad y experiencia. Llevamos más de 25 años
          trabajando con clientes de Pinto, Valdemoro, Getafe, Parla,
          Fuenlabrada y toda la zona sur.
        </p>
        <p className="pt-4 text-base lg:text-lg">
          Nuestra ubicación en Pinto nos permite ofrecer un servicio rápido y
          personalizado. Puedes visitarnos para ver muestras, recoger tu pedido
          o simplemente comentar tu proyecto en persona. Y si lo prefieres,
          también enviamos a toda España.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
          <div className="p-5 rounded-xl shadow-findBox bg-white">
            ...
            <p className="pt-2">
              Papelería corporativa completa: tarjetas, carpetas, cartas,
              catálogos, folletos y material para ferias. Transmite una imagen
          ...
          <div className="p-5 rounded-xl shadow-findBox bg-white">
            ...
            <p className="pt-2">
              Cartelería, precios, promociones, packaging y material para punto
              de venta. Destacar en tu local nunca fue tan fácil.
            </p>
          </div>
          <div className="p-5 rounded-xl shadow-findBox bg-white">
            <h4 className="text-xl font-semibold">Para eventos</h4>
            <p className="pt-2">
              Invitaciones, programas, roll ups, photocalls y todo lo que
              necesitas para que tu evento sea memorable.
            </p>
          </div>
          <div className="p-5 rounded-xl shadow-findBox bg-white">
            <h4 className="text-xl font-semibold">Para particulares</h4>
            <p className="pt-2">
              Invitaciones de boda, libros de fotos, álbumes, tarjetas
              personalizadas y proyectos especiales con tiradas mínimas.
            </p>
          </div>
        </div>
        ...
        <p className="pt-4 text-base lg:text-lg">
          Aunque nuestra sede está en Pinto, damos servicio preferente a todo
          el sur de Madrid:
        </p>
