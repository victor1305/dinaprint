...
const ContactMain: React.FC = () => (
  <div className='text-center max-w-[600px] mx-auto'>
    <h3 className='text-3xl text-[#3d4459] pb-5 leading-8'>
      Si necesitas más información sobre nuestra empresa o sobre nuestros
      servicios,
    </h3>
    <p className='text-[#3d4459] pb-5 leading-6'>
      ponte en contacto con nosotros hoy mismo a través del siguiente
      formulario, llámanos o si lo prefieres te llamamos nosotros. Estaremos
