		...
		<div className="relative lg:hidden">
			...
			<div className="pt-14 px-10 mx-auto max-w-[720px] lg:pb-10">
				...
				<p className="pb-4 text-base">
					En <strong>Dinaprint</strong> llevamos más de 25 años dedicándonos a la comunicación
					gráfica, esto nos ha permitido poder estar a la vanguardia tanto en conocimientos como en
					técnicas de última generación, en un sector que ha experimentado numerosos cambios en los
					últimos tiempos.
				</p>
