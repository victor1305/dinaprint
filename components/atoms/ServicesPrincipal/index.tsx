...
const ServicesPrincipal: React.FC = () => (
  <div className='md:flex justify-center max-w-[1200px] mx-auto'>
    ...
    <div className='p-5 pt-10 md:pt-5 md:w-1/2'>
      ...
      <p>
        Dependemos de nosotros mismos y no de terceros, por lo tanto, el control
        de la producción desde que se acepta el presupuesto, hasta su
        distribución, es solo nuestro. De esta manera nos ajustamos a las
        necesidades de cada cliente, haciendo que su satisfacción se convierta en
        un reto.
      </p>
    </div>
  </div>
