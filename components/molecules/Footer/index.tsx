...
const Footer = () => (
	<footer>
			...
			<div className="max-w-[1300px] mx-auto">
				...
				<div className="text-sm lg:flex lg:pt-3">
					<p className="p-2.5 lg:w-1/5">
						Gracias a las nuevas tecnologías, podemos ofrecer a nuestros clientes la oportunidad de
						materializar cualquier proyecto de impresión que requiera su negocio, ya sea grande o
						pequeño.
					</p>
					<div className="p-2.5 pb-0 lg:pb-2.5 lg:w-1/5">
						...
						<hr />
						<p className="pt-1 pb-1.5">
							<Link href="/catalogo/calendarios" className="text-footer-li hover:text-primary">
								Calendarios
							</Link>
						</p>
					...
					<div className="p-2.5 pt-0 lg:pt-2.5 lg:w-1/5">
						<p className="pt-1 pb-1.5 lg:mt-6">
							<Link href="/catalogo/roll-up" className="text-footer-li hover:text-primary">
								Roll Up
							</Link>
						</p>
						<hr />
						<p className="pt-1 pb-1.5">
							<Link href="/catalogo/expositores" className="text-footer-li hover:text-primary">
								Expositores
							</Link>
						</p>
						<hr />
						...
						<hr />
						<p className="pt-1 pb-1.5">
							<Link href="/catalogo/carteles" className="text-footer-li hover:text-primary">
								Carteles
							</Link>
						</p>
					</div>
					<div className="p-2.5 lg:w-1/5">
						...
						<hr />
						<p className="pt-1 pb-1.5">
							<Link href="/servicios" className="text-footer-li hover:text-primary">
								Soluciones y servicios
							</Link>
						</p>
						<hr />
						<p className="pt-1 pb-1.5">
							<Link href="/blog" className="text-footer-li hover:text-primary">
								Blog
							</Link>
						</p>
						<hr />
						<p className="pt-1 pb-1.5">
							<Link href="/contacto" className="text-footer-li hover:text-primary">
								Contacto
							</Link>
						</p>
						<hr />
						<p className="pt-1 pb-1.5">
							<Link href="/imprenta-madrid" className="text-footer-li hover:text-primary">
								Imprenta en Madrid
							</Link>
						</p>
						<hr />
						<p className="pt-1 pb-1.5">
							<Link href="/imprenta-sur-de-madrid" className="text-footer-li hover:text-primary">
								Imprenta en el sur de Madrid
							</Link>
						</p>
						<hr />
						<p className="pt-1 pb-1.5">
							<Link href="/imprenta-pinto" className="text-footer-li hover:text-primary">
								Imprenta en Pinto
							</Link>
						</p>
					</div>
		...
		<div className="text-[13px] p-2.5 text-center bg-white">
			...
			|{" "}
			<Link href="/politica-de-privacidad" className="text-footer-li hover:text-primary">
				Política de privacidad
			</Link>{" "}
			|{" "}
			<Link href="/politica-de-cookies" className="text-footer-li hover:text-primary">
				Política de cookies
			</Link>
		</div>
	</footer>
